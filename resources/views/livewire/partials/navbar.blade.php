{{-- <header class="fixed top-0 left-0 right-0 z-50 bg-white shadow-md py-2 px-4 text-sm dark:bg-gray-800">
    <div class="max-w-[85rem] mx-auto flex justify-between items-center">
        <!-- Small Navbar Content -->
        <a class="text-xl font-semibold dark:text-white" href="/" aria-label="Brand">Small Brand</a>
        <div class="flex items-center space-x-4">
            <a href="#" class="text-gray-700 dark:text-white hover:text-gray-500 dark:hover:text-gray-300">Link 1</a>
            <a href="#" class="text-gray-700 dark:text-white hover:text-gray-500 dark:hover:text-gray-300">Link 2</a>
        </div>
    </div>
</header> --}}
<header
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a  wire:navigate class="font-medium {{ request()->is('/') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
