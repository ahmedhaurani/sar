...
.navbar {
  ...
  /* padding: 0.5rem 0; Reduced padding to reduce height */
}
...
.nav-link {
  ...
  margin-right: 15px; /* Reduced margin for compact layout */
}
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
                ...
                <li><a class="dropdown-item" href="{{ route('user-requeest') }}"><i class="fas fa-user-circle"></i>الطلبات</a></li>
